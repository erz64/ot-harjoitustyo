...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_saldo_tasa_raha(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_saldo_tasa_raha(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
