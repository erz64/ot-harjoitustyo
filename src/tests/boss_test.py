...
class TestBoss(unittest.TestCase):
    ...
    def test_check_collision_between_boss_and_bullet(self):
        ...
        self.level.bullets.add(self.bullet)
        self.assertEqual(self.level.check_bullet_collision(), True)
    
    def test_boss_will_move(self):
        self.level.boss.move_cooldown = 101
        self.level.boss.update()
        self.assertNotEqual(self.level.boss.rect.y, 300)
    
    def test_boss_will_stop_moving(self):
        self.level.boss.move_cooldown = 101
        self.level.boss.move_duration = 101
        self.assertEqual(self.level.boss.rect.y, 300)
